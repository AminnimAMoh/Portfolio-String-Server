...
function D3() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    if (annualrain.data.length > 0 && svg) {
      Promise.all(/*! import() | D3-Draw */[__webpack_require__.e("vendors-node_modules_pnpm_css-loader_6_8_1_webpack_5_88_2_node_modules_css-loader_dist_runtim-8351bb"), __webpack_require__.e("D3-Draw")]).then(__webpack_require__.bind(__webpack_require__, /*! ./Draw */ "./txsrc/views/Pages/D3/Draw.js")).then(_ref => {
        let {
          default: Draw
        } = _ref;
