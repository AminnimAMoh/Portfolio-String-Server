...
import { onClickTextFunction, slumScale, citiesProjection, geoLocations, } from "./utilities";
export const draw = (container, svgRef, annualrain, slums, population, months) => {
    ...
    shadowGenerator(container, "legend-drop-shadow", "330%", "330%", 1, 10, 5, 0.2);
    ...
    function reDrawCan() {
        ...
        generatedGroups.mapContainer.attr("transform", "translate(" + mapXOffSet + ",0)");
        generatedGroups.legendGraph.attr("transform", "translate(" + (265 + mapXOffSet) + " ," + h + ")");
        generatedGroups.ellipseContainer
            ...
            .attr("rx", 0)
            .attr("ry", 0);
        generatedGroups.cityCircles.attr("transform", "translate(" + mapXOffSet + ",0)");
        generatedGroups.cityLables.attr("transform", "translate(" + mapXOffSet + ",0)");
        generatedGroups.ellipseContainer.attr("transform", "translate(" + mapXOffSet + ",0)");
        let managedArray = [];
        ...
        generatedGroups.cityCircles
            ...
            .on("click", function () {
            stationsClick(population, months, yearSelected, generatedGroups, d3, mapXOffSet, this);
        });
        ...
        generatedGroups.yearsContainer
            ...
            DrawAll(d3, annualrain, yearListSelected, yearSelected, firstMin, firstMax, generatedGroups);
        });
        removeEllipses(d3, container, generatedGroups);
        DrawAll(d3, annualrain, 2013, yearSelected, firstMin, firstMax, generatedGroups);
