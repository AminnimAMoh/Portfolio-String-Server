...
/* harmony import */ var _material_ui_core_Slide__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @material-ui/core/Slide */ "@material-ui/core/Slide");
/* harmony import */ var _material_ui_core_Slide__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_material_ui_core_Slide__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _AppStyle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./AppStyle */ "./txsrc/AppStyle.tsx");
...
/* harmony import */ var _redux_slices_fetchSlice__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./redux/slices/fetchSlice */ "./txsrc/redux/slices/fetchSlice.tsx");
/* harmony import */ var _views_DataFetchPending__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./views/DataFetchPending */ "./txsrc/views/DataFetchPending/index.tsx");
/* harmony import */ var _views_MenuButton__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./views/MenuButton */ "./txsrc/views/MenuButton/index.tsx");
/* harmony import */ var _views_ContentContainer__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./views/ContentContainer */ "./txsrc/views/ContentContainer/index.tsx");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./utils */ "./txsrc/utils.tsx");
...
function TransitionUp(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Slide__WEBPACK_IMPORTED_MODULE_1___default()), _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_2___default()({}, props, {
    direction: "up"
  }));
}
...
function App() {
  // console.clear();
  const [svgSetupTrigger, setSVGSetupTrigger] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
  const [snackState, setSnackState] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(false);
  const dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_5__.useDispatch)();
  const matches = _material_ui_core_useMediaQuery__WEBPACK_IMPORTED_MODULE_7___default()('(min-width:600px)');
  console.log(matches);
  const {
    buttonAction: {
      rootState,
  ...
  const classes = (0,_AppStyle__WEBPACK_IMPORTED_MODULE_4__.default)(); //This hook listens to the size changes on the browser window.
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
    if (!_utils__WEBPACK_IMPORTED_MODULE_12__.isBrowser) {
  ...
  const snackBarRefreshAction = () => {
    ...
    dispatch((0,_redux_slices_fetchSlice__WEBPACK_IMPORTED_MODULE_8__.readDataAgain)()); //Close the snack bar.
  ...
  }, !svgSetupTrigger && buttonTrigered === "D3" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", {
    className: classes.loading
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_views_DataFetchPending__WEBPACK_IMPORTED_MODULE_9__.default, null), ";"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Snackbar__WEBPACK_IMPORTED_MODULE_0___default()), {
    open: snackState,
  ...
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_views_MenuButton__WEBPACK_IMPORTED_MODULE_10__.default, null), ";", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_views_ContentContainer__WEBPACK_IMPORTED_MODULE_11__.default, null), ";");
}
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils */ "./txsrc/utils.tsx");
/* harmony import */ var _redux_slices_buttonActionSlice__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../redux/slices/buttonActionSlice */ "./txsrc/redux/slices/buttonActionSlice.tsx");
...
const calPos = (index, length, size, state) => {
  if (!_utils__WEBPACK_IMPORTED_MODULE_4__.isBrowser) {
    if (window.innerWidth > 1280) {
...
function MenuButton() {
  const classes = (0,_style__WEBPACK_IMPORTED_MODULE_1__.default)();
  const dispatch = (0,react_redux__WEBPACK_IMPORTED_MODULE_3__.useDispatch)(); // const [showInfo, setShowInfo] = useState<boolean>(false);
  ...
  const handlePowerClick = () => {
    ...
    if (rootState) {
      dispatch((0,_redux_slices_buttonActionSlice__WEBPACK_IMPORTED_MODULE_5__.containerStateToggle)("PowerButton"));
      setTimeout(() => {
        dispatch((0,_redux_slices_buttonActionSlice__WEBPACK_IMPORTED_MODULE_5__.onDelayStateChange)());
      }, 500);
    } else {
  ...
  const handleClick = e => {
    ...
    dispatch((0,_redux_slices_buttonActionSlice__WEBPACK_IMPORTED_MODULE_5__.containerStateToggle)(payload));
  };
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _material_ui_core_Divider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @material-ui/core/Divider */ "@material-ui/core/Divider");
/* harmony import */ var _material_ui_core_Divider__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_material_ui_core_Divider__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../styles */ "./txsrc/views/Pages/styles.tsx");
...
function CV() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement("div", {
    className: classes.root
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    container: true,
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "h3"
  }, "Mohammad Amin Mohammadi"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "h4"
  }, "React.js Developer"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "h4"
  }, "Front-End Developer"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body2",
    style: {
      fontSize: "12px",
      color: "#426164"
    }
  }, "Top Skills:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body2",
    style: {
      fontSize: "12px",
      color: "#426164"
    }
  }, "React.js, React-Redux, Redux ToolKit, React Hooks, React Functions,TypeScript, Axios, D3.js, JavaScript Vanilla, JSX, HTML, CSS, Material-UI.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    lg: 6,
    md: 12,
    ...
    variant: "body1"
  }, "I am graduated from the University of Sydney Bachelor of Design Computing that empowers me with knowledge and experience in User Experience Design and User Interaction Design alongside my speciality in React.js Front-End Development. After mastering skills in CSS, HTML, JavaScript, D3.js, P5.js, P3 Processing Java I fell in love with React.js and have developed several projects in React.js and TypeScripts. After puting my skills in to a real-world test I have mastered React Hooks, React-Redux, Redux ToolKir, TypeScript, Axios Interceptors, Restful API, and Authentication.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    container: true,
    xs: 12,
    spacing: 4,
    ...
    variant: "h3"
  }, "Education")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    container: true,
    xs: 12,
    spacing: 4,
    ...
    variant: "h4"
  }, "Bachelor of Design Computing"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "University of Sydney"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "Jul 2017 \u2014 Dec 2020")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    xs: 12,
    sm: 6
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "Certified skills in User Experience Design, User Interaction Design, and Front-End Development. Mastering programming skills in React.js, React-Redux, Redux ToolKit, Axios, Material-UI, D3.js, JavaScript Vanilla, JSX, HTML & CSS.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    xs: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "h4"
  }, "Achivements")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    xs: 12,
    sm: 6
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "University of Sydney hackathon Coding Fest 2020 Disaster Prevention Project Award."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Link__WEBPACK_IMPORTED_MODULE_1___default()), {
    href: "",
    onClick: e => handleLinkClick(e, "D3")
  }, "Bangladesh Rainfall Visualization.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    xs: 12,
    sm: 6
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "Fighting misinformation through social media around the Covid-19 news."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Link__WEBPACK_IMPORTED_MODULE_1___default()), {
    href: "",
    onClick: e => handleLinkClick(e, "UI")
  }, "Covid Fact Check App-Developed in React.js.")))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    container: true,
    xs: 12,
    spacing: 4,
    ...
    variant: "h3"
  }, "Experience")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    container: true,
    xs: 12,
    spacing: 4,
  ...
  }, "React Developer"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "Reesby"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "Mar 2021 \u2014 Present")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    xs: 12,
    sm: 6
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "React Front-End Developer in Reesby. Leader of Front-End development team. Developed Reesby main project landing page using React, React-Redux, React-Spring and Material-UI.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    xs: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "h4"
  }, "Responsibilities")), reesbyResponsibilities.map(data => {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
      item: true,
      xs: 12,
      sm: 4,
      key: data
    ...
    variant: "body1"
  }, "Three times nominated as the team member of the CRM team for dedication and hard work resulted in great outcomes."))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    xs: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Divider__WEBPACK_IMPORTED_MODULE_0___default()), {
    variant: "middle",
  ...
  }, "Freelance Front End Development"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "Freelance"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "2019 \u2014 Present")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    xs: 12,
    sm: 6
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "Working from home on projects involve JavaScript programming and UI design.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    xs: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "h4"
  ...
  }, "Mentoring Class Mates"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "University of Sydney"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "Feb 2019 \u2014 Dec 2019")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    xs: 12,
    sm: 6
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "body1"
  }, "Mentoring classmates to learn HTML/CSS/JavaScripts and P5.js.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_2___default()), {
    item: true,
    xs: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_4___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_3___default()), {
    variant: "h4"
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../styles */ "./txsrc/views/Pages/styles.tsx");
...
function UI() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", {
    className: classes.root
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    container: true,
    justify: "space-between",
    alignContent: "flex-start",
    className: classes.topic_grid
    ...
    md: 12,
    className: classes.topick_heading
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h3"
  }, "Figting misinformation through social media"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h4"
  }, "Collaboration Team:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body2",
    style: {
      fontSize: "12px",
      color: "#426164"
    }
  }, "Developer and Video: Mohammad Amin Mohammadi"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body2",
    style: {
      fontSize: "12px",
      color: "#426164"
    }
  }, "UX/UI Designer and documentation: Jessica Owens"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Link__WEBPACK_IMPORTED_MODULE_1___default()), {
  ...
  }, "Link to our high-fidelity prototype")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Link__WEBPACK_IMPORTED_MODULE_1___default()), {
    ...
    variant: "h5",
    className: classes.link_ToExternals
  }, "Link to full report"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 6,
    md: 12,
    className: classes.topic_pragraph
    ...
    variant: "h3"
  }, "React.js")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    xs: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "Currently our planet is at a critical point of animal extinction and bidovirsty loss. To aid in combatting this loss we have designed the Atmoscube. Through research conducted at the beginning of the design process we\u2019ve identified that people often feel unempowered in their ability to help the environment. To solve this problem, we have aimed to create an experience that informs and engages the user in an effort to educate and empower. Empowerment provided by interacting with the atomscube is designed to permeate throughout the users daily life, providing them with a platform to continue with environmentally positive life choices."))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    container: true,
    xs: 12,
    spacing: 4,
    ...
    variant: "h3"
  }, "React Hooks")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 6,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h5"
  }, "useState"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "\"useState\" is a React hook function that allows us to change the state of the function components if required. React hook functions are well design to secure the function component from possible errors in the code as well as stabilizing the connection between components between classes.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 6,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h5"
  }, "useEffect"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "\"useEffect\" function is another React hook that allows us to read from our API data base only on specified circumstances. \"useEffect\" helps us to minimize the tokens on our API and reduces the load on the API server. In this application, we mainly use the \"useEffect\" hook to read and write on our API database with a minimum number of tokens for each request to maintain the API service."))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    container: true,
    xs: 12,
    spacing: 4,
    ...
    variant: "h3"
  }, "React-Router")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 6,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h5"
  }, "useHistory"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "\"useHistory\" is a hook function from React Router Core npm to trigger the Link function in a class function rather than the render function. \"useHistory\" in this application allows us to route between pages using different states of function components in conditions. In this application, this condition listens to the direction of the user's swipe.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 6,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h5"
  }, "Switch"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "\"Switch\" is unique in that it renders a route exclusively. In contrast, every \"Route\" that matches the location renders inclusively.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 6,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h5"
  }, "Route"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "\"Route\" most basic responsibility is to render some UI when its path matches the current URL passed as the path. \"Route\" also sets the props required for the routing component and on each request to the path it makes the hook between the sender and receiver component.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 6,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h5"
  }, "Link"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
    ...
    variant: "h3"
  }, "Google Firebase")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    xs: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
    ...
    variant: "h5"
  }, "Data set One"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "One firebase data document is used to reserve the questions in. This allows for easy updates of the questions.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 4,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h5"
  }, "Data set Two"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "The second data document collects the users\u2019 final results as well as their postcode. After a user is done the result and postcode of the question will be saved on this repository in the form of an array of objects. This information instantly will be downloaded from the API to draw the graph in the next page.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 4,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h5"
  }, "Build and Publish"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "Thirdly, Google Firebase helps build and deploy the application on its servers from React.js. Google fiFirebase provides this service for free in addition to all other mentioned services."))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    container: true,
    xs: 12,
    spacing: 4,
    ...
    variant: "h3"
  }, "Tinder Swipe for React Library")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    xs: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "This is a pre-build swipe listener library that provides a very smooth swipe animation to given elements. Using this library on questions card as clear user feedback on their swipe actions. This library also allows the application to count the correct answers as well as the total number of questions answered. Using the \u201DonSwipe\u201D listener built-in on this library we can monitor the direction the swipe user makes for each question.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 6,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h5"
  }, "React Router"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "React router library: this library allows the application to easily move between pages. This library allows for multiple pages in the application. Separating actions and information in different pages improves the flow of the application. A benefit of this separation is the minimisation of the amount of information users have to process at a time.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 6,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h5"
  }, "D3.js"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
...
function UX() {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement("div", {
    ...
    variant: "h3"
  }, "User Experience Case Studies. Environmental Conservation."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h4"
  }, "Collaboration Team:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body2",
    style: {
  ...
  }, "User Journey Map & Documentation: Mohammad Amin Mohammadi"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body2",
    style: {
      fontSize: "12px",
      color: "#426164"
    }
  }, "User Testings & Video: Brendan O'Reilly"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body2",
    style: {
      fontSize: "12px",
      color: "#426164"
    }
  }, "Synthesizing Activity Design: Elliott Magrath"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Link__WEBPACK_IMPORTED_MODULE_1___default()), {
    ...
    variant: "h5"
  }, "Knowledge As a tool to conserve"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h3"
  }, "Environment and Biodiversity"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    container: true,
    ...
    variant: "h5"
  }, "What is the strategy?"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h3"
  }, "Design Solution")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 6,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "Our design Solution is the Atmoscube, a cube roughly 450mm in width, height and depth. Within this hologram cube we are propose a city build game. The top of the product houses a touch and distance sensitive interface that along with AI voice operated system will be the way in which the user engages with the product. Within the product will be a small AR city projected from the base, this AR city will be built and managed by the user."))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    xs: 12
    ...
    variant: "body1"
  }, "The design process was guided by the aim of empowering people through education in an effort to aid against biodiversity loss and animal extinction."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "Stage one of the design process involved conducting research with finding key insights regarding the problem space in mind."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "Stage two of the process involved studying the research gathered, finding explicit and intrinsic insights into solutions for the problem space."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "Stage Three involved each design member submitting two idea and subsequent storyboards that aided the problem space and successfully met design criteria."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "body1"
  }, "Stage Four involved each design team members idea being inputted into a design matrix created to highlight the best design and what was most suited to the tasks needs.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    lg: 6,
    md: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h5"
  }, "Trial and Error"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h3"
  }, "Design Process"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    xs: 12
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement("img", {
    ...
    variant: "h5"
  }, "Design Communicatin Tool"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_2___default()), {
    variant: "h3"
  }, "User Journy Map")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Grid__WEBPACK_IMPORTED_MODULE_0___default()), {
    item: true,
    xs: 12,
    style: {
      paddingTop: "12px"
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3___default().createElement((_material_ui_core_Link__WEBPACK_IMPORTED_MODULE_1___default()), {
